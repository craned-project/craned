  ...
  return (
    <Form {...form}>
      <form
        ...
        className={cn(
          "flex flex-col gap-1 justify-center items-center flex-3 m-7 rounded-lg p-3 w-full bg-pri h-min",
          className,
        )}
      >
        <FormLabel className="text-4xl font-bold text-tri block w-full">
          New Post!
        </FormLabel>
        <FormField
          ...
          render={({ field }) => (
            <FormControl>
              <FormItem className="">
                {field.value ? (
                  <div className="mt-4">
                    <FormLabel className="absolute z-[3] top-[38%] right-[32%]">
                      <div className="rounded-full bg-tri p-2 flex justify-center items-center h-[70px] w-[70px]">
                        <svg
                    ...
                    <Image
                      ...
                      height={400}
                      priority
                      className="rounded-xl object-cover w-[400px] h-[400px] z-[1] block relative bg-tri"
                    />
                  </div>
                ) : (
                  <FormLabel className="absolute z-[3] top-[58%] right-[28%]">
                    <div className="rounded-full bg-tri p-2 flex justify-center items-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 512 512"
                        className="fill-white h-[40px] w-[40px]"
                      >
                        <path d="M0 96C0 60.7 28.7 32 64 32H448c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96zM323.8 202.5c-4.5-6.6-11.9-10.5-19.8-10.5s-15.4 3.9-19.8 10.5l-87 127.6L170.7 297c-4.6-5.7-11.5-9-18.7-9s-14.2 3.3-18.7 9l-64 80c-5.8 7.2-6.9 17.1-2.9 25.4s12.4 13.6 21.6 13.6h96 32H424c8.9 0 17.1-4.9 21.2-12.8s3.6-17.4-1.4-24.7l-120-176zM112 192a48 48 0 1 0 0-96 48 48 0 1 0 0 96z" />
                      </svg>
                    </div>
