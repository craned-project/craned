...
const Post = ({ name, username, date, desc, image, pfp, comments, like }: PostProps) => {
  return (
    ...
    <div className="p-3 w-1/3 rounded-2xl bg-darksec">
      ...
      <div className="flex justify-around mt-1">
            <div className="flex gap-1">
                <button>
                  <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" className="fill-lightpri">
